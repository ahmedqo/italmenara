...
@section('content')
    ...
    <section class="w-full container mx-auto p-4 grid grid-rows-1 grid-cols-1 lg:grid-cols-6 gap-8">
        <div class="flex flex-col gap-6 lg:col-span-4">
            ...
            <ul tabs class="flex flex-col gap-4">
                @foreach ([
            [
                'ttl' => __('Link One'),
                'txt' => 'hello world jdlkljf dfdjhfd ahmed dfdkdfjdf dfjhfd hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd.',
            ],
            [
                'ttl' => __('Link Two'),
                'txt' => 'hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd.',
            ],
            [
                'ttl' => __('Link Three'),
                'txt' => 'hello world jdlkljf dfdjhfd dfdkdfjdf dfjhfd.',
