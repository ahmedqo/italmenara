...
@section('content')
    <div class="flex flex-col gap-2">
        <os-data-visualizer print search filter download title="{{ __('Brands List') }}">
            <a slot="end" title="{{ __('Create') }}" href="{{ route('views.brands.store') }}"
...
@section('scripts')
    <script>
        ...
        TableVisualizer(dataVisualizer, 'brands', {
